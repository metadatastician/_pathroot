...
Replace all {{PLACEHOLDER}} values with your information:
  Ambientops     - Your project name
  hyperpolymath            - GitHub username or org (e.g., hyperpolymath)
  ambientops             - Repository name
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/ambientops/security/advisories/new) or 6759885+hyperpolymath@users.noreply.github.com |
