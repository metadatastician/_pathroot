...
// SPDX-FileCopyrightText: 2026 hyperpolymath (metadatastician) <hyperpolymath@example.com>
= Contributing — _pathroot
:revdate: 2026-MM-DD

== Audience

Developers working *on* `_pathroot`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/_pathroot.git
cd _pathroot
...
* Bugs in `_pathroot`: file at `metadatastician/_pathroot/issues`.
